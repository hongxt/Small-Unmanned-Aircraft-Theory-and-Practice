...
%uu，无人机的12个状态参数
%V，vertices，无人机的顶点的坐标3*n
%F，faces，面的点集，按照顺序，比如一个面是1，2，3，4的连线，则是1，2，3，4；
%patchcolors，列向量，每一行是每个面的对应的颜色的rgb数值


    % process inputs to function画面的方法
...
function XYZ=rotate(XYZ,phi,theta,psi);
  ...
  R_yaw = [...
          ...
          sin(psi), cos(psi), 0;...
          0, 0, 1];
  R = R_yaw*R_pitch*R_roll;%外旋
  R = R_roll*R_pitch*R_yaw;%内旋
  % rotate vertices
  XYZ = R*XYZ;
end
